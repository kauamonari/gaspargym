...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FitDiet — Controle de dieta e macros" },
      { name: "description", content: "Acompanhe calorias, proteínas, carboidratos e gorduras com um app fitness premium." },
      { name: "author", content: "FitDiet" },
      { property: "og:title", content: "FitDiet — Controle de dieta e macros" },
      { property: "og:description", content: "Acompanhe calorias, proteínas, carboidratos e gorduras com um app fitness premium." },
