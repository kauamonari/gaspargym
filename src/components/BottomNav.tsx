...
const items = [
  ...
  { to: "/workout", label: "Treino", icon: Dumbbell, activeClass: "data-[status=active]:text-workout" },
  { to: "/days", label: "Dias", icon: CalendarDays, activeClass: "data-[status=active]:text-primary" },
